...
import HomecoffeeScreen from './HomecoffeeScreen';
import HomebeanScreen from './HomebeanScreen';
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.menuContainer}>
                ...
                <View style={styles.bgr}>
                    <View style={styles.bgr1}>
                        <Image style={styles.img} source={require('../assets/images/account.png')} />
                        <TouchableOpacity>
                ...
                <View style={styles.bgr}>
                    <View style={styles.bgr1}>
                        <Image style={styles.img} source={require('../assets/images/location.png')} />
                        <TouchableOpacity>
